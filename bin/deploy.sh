...
rsync_args="-arvuz $script_dir/../ prod@monomyth.io:/home/prod/public/admin.reliefdb.org --delete --exclude-from $script_dir/exclude.txt"
site_dir='admin.reliefdb.org'
...
echo $'\033[0;33m'
echo $'step four: restart nginx on server'
echo $'\033[0m'
